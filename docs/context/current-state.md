...
Current validation: production build passes; 18 xUnit parser/model tests pass. Both new migrations were applied to PostgreSQL 17, including an upgrade test that retained historical daily and raw records.
